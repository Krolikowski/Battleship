...
def draw_markers(xlist, ylist):
    ...
    for i in range(len(xlist)):
        ...
        top = YMARGIN
        marker_surf, marker_rect = make_text_objs(letters[i],
                                                    BASICFONT, TEXTCOLOR)
    ...
    for i in range(len(ylist)):
        ...
        marker_surf, marker_rect = make_text_objs(str(i), 
                                                    BASICFONT, TEXTCOLOR)
        marker_rect.topleft = (left, top)
        DISPLAYSURF.blit(marker_surf, marker_rect)
...
def show_help_screen():
    ...
    line3_surf, line3_rect = make_text_objs('shots as possible. To reset ' \
                'your game click on the "New Game" button.', BASICFONT, TEXTCOLOR)
